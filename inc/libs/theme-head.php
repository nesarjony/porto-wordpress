...
if( !function_exists('portoLogo') )
{
	...
	{
		if(cs_get_option('logo') || cs_get_option('text_logo'))
		{
			echo '<a href="';
...
if( !function_exists('portoHeaderOptions') )
{
	function portoHeaderOptions( $layout='default' )
	{
		...
		$nav_section_class = [
				 ...
				 'SemiTransparent' 		   => 'header-nav',
				 'SemiTransparentLight'    => 'header-nav',
				 'TransparentBottomBorder' => 'header-nav',
				 'NavigationTopLine' 	   => 'header-nav',
		...
		if( $layout == "Flat" || $layout == "FlatTopBar" || $layout == "Transparent" || $layout == "SemiTransparent"|| $layout == "SemiTransparentLight" || $layout == "TransparentBottomBorder" || $layout == "DarkDropdown")
		{
			if( cs_get_option('menu_style') )
			{
				$options['nav_section_class'] .= " ".cs_get_option('menu_style');
			}
		}
