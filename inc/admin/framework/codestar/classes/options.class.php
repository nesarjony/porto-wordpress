...
abstract class CSFramework_Options extends CSFramework_Abstract {
  ...
  public function element_value( $value = '' ) {
    ...
    // Customly Added FIeld
    if( isset( $this->field['default_priority'] ) )
    {
      $value = $this->field['default'] ? $this->field['default'] : '0' ;
      return $value; 
    } 
    // End Customly Added Field
  ...
  // Customly Added Field
  public function element_image_label( ) {

    $image_label = ( isset( $this->field['image_label'] ) ) ? $this->field['image_label'] : false;
    return $image_label;
